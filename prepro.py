...
import h5py
import numpy as np
#import scipy.misc import imread, imresize
...
def prepro_captions(imgs):
  ...
  for i,img in enumerate(imgs):
    ...
    for j,s in enumerate(img['captions']):
      ...
      txt = str(s).lower().translate(punctuation_table).strip().split()
...
def encode_captions(imgs, params, wtoi):
  ...
  print(f'encoded captions to array of size {L.shape}') #Said changed this part.
